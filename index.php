...
<div id="header">
    <div class="container">
        <nav>
            <img src="home/images/logo.jpg" class="logo">
            <ul id="sidemenu">
...
<div id="gallery">
    <div class="container">
        ...
        <div class="work-list">
            <div class="work">
                <img src="home/images/bigbeak.jpg">
                <div class="layer">
                    <h3>Hornbill</h3>
            ...
            <div class="work">
                <img src="home/images/blueparrot.jpg">
                <div class="layer">
                    <h3>Rare bird</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="contact-left">
               ...
               <p>       +9779842626061</p>
                <a href="home/images/GreenEarthBrochure.pdf" download class="btn btn2">Download Brochure</a>
            </div>
